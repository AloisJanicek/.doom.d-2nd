...
(map!
 ...
 (:prefix ("o" . "open")
  ...
  (:prefix ("o" . "open agenda")
   ...
   :desc "past due tasks NO-FILTER"     "a" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-past-dues-query) :sort-fn 'date :reverse t :time t :capture-key "d"))
   :desc "archived"             "A" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-done-query) :files (aj-get-all-archived-org-files) :capture-key "k"))
   ...
   :desc "next"                 "n" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-custom-next-task-query) :capture-key "t"))
   :desc "tasks"                "t" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-custom-todo-task-query) :sort-fn 'date :reverse t :capture-key "t"))
   :desc "all tasks"            "T" (cmd! (aj/org-agenda-headlines :capture-key "t"))
   :desc "projects"             "p" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-custom-projects-query) :capture-key "t"))
   :desc "wait"                 "w" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-custom-wait-task-query) :sort-fn 'date :capture-key "t"))
   :desc "hold"                 "h" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-custom-hold-task-query) :sort-fn 'date :capture-key "t"))
   :desc "someday"              "s" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-simple-task-query "SOMEDAY") :sort-fn 'random :capture-key "t"))
   :desc "maybe"                "m" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-simple-task-query "MAYBE") :sort-fn 'random :capture-key "t"))
   :desc "cancelled"            "c" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-simple-task-query "CANCELLED") :sort-fn 'date :capture-key "k"))
   :desc "done"                 "d" (cmd! (aj/org-agenda-headlines :query (aj-org-ql-simple-task-query "DONE") :sort-fn 'date :capture-key "k"))
   )
  )
