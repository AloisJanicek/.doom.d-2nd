...
(map!
 ...
 (:prefix ("n" . "notes")
  ...
  :desc "notes headlines"    "n" (λ! (aj-org-jump-to-headline-at aj-org-technical-dir 2 aj-org-technical-notes-filter-preset))
  :desc "org-dir"            "o" (λ! (aj-org-find-file org-directory))
  :desc "personal"           "P" (λ! (aj-org-find-file aj-org-personal-dir))
  :desc "personal headlines" "p" (λ! (aj-org-jump-to-headline-at aj-org-personal-dir 2 aj-org-personal-notes-filter-preset))
  :desc "query"              "q" #'org-ql-search
  :desc "private headlines"  "r" (λ! (aj-org-jump-to-headline-at aj-org-private-dir 2 aj-org-private-notes-filter-preset))
