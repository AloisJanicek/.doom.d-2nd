...
(map!
 ...
 (:prefix ("o" . "open")
  ...
  (:prefix ("o" . "open agenda")
   :desc "clocked"              "c" (cmd! (aj/org-agenda-headlines :prompt (format "clocked %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-custom-clocked-task-query) :sort-fn 'date :capture-key "k"))
   :desc "all active"           "o" (cmd! (aj/org-agenda-headlines :prompt (format "all active %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-all-active-tasks-query)))
   :desc "past due NO-F"        "a" (cmd! (aj/org-agenda-headlines :prompt (format "past due %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-past-dues-query)
                                                                   :sort-fn 'date :reverse t :time t :capture-key "t"))
   :desc "future due NO-F"      "b" (cmd! (aj/org-agenda-headlines :prompt (format "future due %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-future-dues-query)
                                                                   :sort-fn 'date :reverse t :time t :capture-key "t"))
   :desc "tickler reminders"    "B" (cmd! (aj/org-agenda-headlines :prompt (format "tickler reminders %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
   ...
   :desc "stand-alone tasks"    "t" (cmd! (aj/org-agenda-headlines :prompt (format "stand-alone tasks %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-custom-todo-task-query) :sort-fn 'date :reverse t :capture-key "t"))
   :desc "all tasks"            "T" (cmd! (aj/org-agenda-headlines :capture-key "t"))
   :desc "projects"             "p" (cmd! (aj/org-agenda-headlines :prompt (format "projects %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-custom-projects-query) :capture-key "t"))
   :desc "wait"                 "w" (cmd! (aj/org-agenda-headlines :prompt (format "wait %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-custom-wait-task-query) :sort-fn 'date :capture-key "t"))
   :desc "hold"                 "h" (cmd! (aj/org-agenda-headlines :prompt (format "hold %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-custom-hold-task-query) :sort-fn 'date :capture-key "t"))
   :desc "someday"              "s" (cmd! (aj/org-agenda-headlines :prompt (format "someday %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-simple-task-query "SOMEDAY") :sort-fn 'random :capture-key "t"))
   :desc "maybe"                "m" (cmd! (aj/org-agenda-headlines :prompt (format "maybe %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-simple-task-query "MAYBE") :sort-fn 'random :capture-key "t"))
   :desc "cancelled"            "C" (cmd! (aj/org-agenda-headlines :prompt (format "cancelled %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
                                                                   :query (aj-org-ql-simple-task-query "CANCELLED") :sort-fn 'date :capture-key "k"))
   :desc "done"                 "d" (cmd! (aj/org-agenda-headlines :prompt (format "done %s" (cdr (aj-org-ql-custom-agenda-filter-tags)))
