...
(map!
 ...
 (:prefix ("o" . "open")
  ...
  (:prefix ("o" . "open agenda")
   ...
   :desc "all tasks"            "T" (cmd! (aj/org-agenda-headlines nil nil nil #'aj-org-ql-sort-by-todo))
   :desc "projects"             "p" (cmd! (aj/org-agenda-headlines nil (aj-org-ql-custom-projects-query) nil #'aj-org-ql-sort-by-todo))
